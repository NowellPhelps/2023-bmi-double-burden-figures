...
for (var in variables){
  for(my_sex in sexes){
    ...
    saveWidget(plotly.ps[[paste("Scatter", my_sex, var)]], paste0(outdir_folder, "Change in ", get_var_longname(var)," ", plot.start.year, " - ", plot.end.year, " v level in ",level.year, " ", ifelse(my_sex == "female", "girls", "boys"), ".html"), selfcontained = F, libdir = "lib")
  }
}
