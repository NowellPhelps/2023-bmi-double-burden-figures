...
for (var in variables){
  ...
  for(my_sex in sexes){
    ...
    saveWidget(plotly.ps[[paste("Scatter", my_sex, var)]], paste0(outdir_folder, str_to_sentence(get_var_longname(var))," ", plot.start.year, " v ", plot.end.year, " ",ifelse(my_sex == "female", "girls", "boys"), ".html"), selfcontained = F, libdir = "lib")
    }
}
