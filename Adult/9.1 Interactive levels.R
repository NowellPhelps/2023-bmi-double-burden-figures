...
if(age_type == "adult"){
  variables <- c("prev_bmi_l185", 
                 ...
                 "prev_bmi_35",
                 "prev_bmi_35_proportion_obesity")
} else{
...
data_timechange$Region <- factor(data_timechange$Region)
...
for (var in variables){
  for(my_sex in sexes){
    ...
    saveWidget(a, paste0(outdir_folder, str_to_sentence(get_var_longname(var)), " level " , my_sex, ".html"), selfcontained = F, libdir = "lib")
  }
}
